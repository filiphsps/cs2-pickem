...
import { ApiError, NetworkError, mapHttpError } from "../errors"

export interface HttpClient {
  get(url: string, params?: Record<string, string>): Effect.Effect<unknown, ApiError | NetworkError>
  post(url: string, body: Record<string, string>): Effect.Effect<unknown, ApiError | NetworkError>
}
